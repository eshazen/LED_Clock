//
// Clock display driven by serial port
// Clock runs on it's own but without setting pins
//
...
static unsigned t_hr = 11;
static unsigned t_min = 55;
static unsigned t_sec = 50;
