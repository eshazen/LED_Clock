...
# Ring radii
RADIUS_FAST    = 240   # fast outer ring
RADIUS_SECONDS = 200
RADIUS_MINUTES = 160
RADIUS_HOURS   = 120

DOT_RADIUS = 6
UPDATE_MS = 1000 // 60  # ~16.7 ms (60 Hz)
...
fast_index = 0  # advances 60x per second
